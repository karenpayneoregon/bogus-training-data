...
public class HumanGenerator
{
    ...
    public static List<Human> Create(int count, bool random = false)
    {
        ...
        var faker = new Faker<Human>()
            ...
            // Pick either BirthDay or BirthDate 
    ...
    /// <summary>
    /// Generates a single realistic, randomized <see cref="Human"/> object.
    /// </summary>
    /// <param name="random">
    /// A boolean value indicating whether the generated <see cref="Human"/> object should have randomized data.
    /// If <c>false</c>, deterministic data is used.
    /// </param>
    /// <returns>
    /// A single instance of a <see cref="Human"/> object populated with realistic data.
    /// </returns>
    /// <remarks>
    /// This method leverages the <see cref="Create(int, bool)"/> method to generate a single <see cref="Human"/> object.
    /// It is particularly useful when only one instance is required instead of a collection.
    /// </remarks>
    public static Human CreateOne(bool random = false) 
